...
- 2026-09-24: Decision A19 (consumers pin actions by commit hash; exact versions as immutable Releases), `docs/adr/0003`, and its Progress entry; the Interfaces section's reference form updated to match.
