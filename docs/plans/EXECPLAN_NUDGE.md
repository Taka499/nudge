...
- [ ] Acceptance, refusals and self-hosting: `.github/workflows/acceptance.yml` against `nudge.tia.run` and a throwaway second instance (`wrangler.toml` `[env.acceptance]`); then the `v1` tag.
